...
*/
	...
	case ( empty($action) )	:
		...
		break;
	case 	'drawjs'	:	 //  **** drawjs  ****  //javascript 版//
	
//}elseif($_GET['mod'] == 'drawjs'){  
	
		$FormulaSet = array( "macd"); //, "ma","vol","vol", "macd"
		...
		if(!empty($_POST['stock_code'])){
			...
			echo $NowFormula,$_POST['stock_code'];
...
case 	('edit_formula' && $_GET['stockid']) 	:
