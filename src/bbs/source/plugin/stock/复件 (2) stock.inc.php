...
//	include './source/plugin/stock/func/yahoocsv.func.php';
...
//	$query = DB::query("SELECT * FROM ".DB::table('stock')." ORDER BY id DESC LIMIT 0, 30");
	...
	while($stock = DB::fetch($query)){
		$stock['dateline'] = dgmdate($stock['dateline'], 'dt', $_G['setting']['timeoffset']);
		$stocklist[]=$stock;
		//$_POST["select_cycle"]
...
$FormulaSet = array("ma","vol", "macd"); //, "vol", "macd"
