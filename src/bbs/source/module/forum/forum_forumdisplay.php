...
// 查询所有论坛分类明细 
$query = DB::query("SELECT fid,name FROM ".DB::table('forum_threadclass')." ORDER BY fid ");
 	$ForumType = array();
	while($temp_type = DB::fetch($query)){
		$ForumType[] = $temp_type;
	}
...
//echo getcwd();
//include "./source/include/space/space_favorite.php";
//error_reporting(E_ALL);
/*
////////////////////////////////////////////////////////// test menu auto by ioying 20140310
session_start();
if(isset($_SESSION['menuviews'])){
//  $_SESSION['views']=$_SESSION['views']+1;
}else{
  $_SESSION['menuviews']=1;}
//echo "Views=". $_SESSION['menuviews'];


if (isset($_COOKIE["CookieMenuViews"])){
 // echo "Welcome " . $_COOKIE["CookieMenuViews"] . "!<br />";
}else{
 setcookie("CookieMenuViews", "0", time()+3600);}
