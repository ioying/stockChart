...
0
|| checktplrefresh('./source/plugin/tsound_wenda/template/header.htm', './template/links/common/header.htm', 1403249087, 'tsound_wenda', './data/template/7_tsound_wenda_header.tpl.php', './source/plugin/tsound_wenda/template', 'header')
|| checktplrefresh('./source/plugin/tsound_wenda/template/header.htm', './template/default/common/header_common.htm', 1403249087, 'tsound_wenda', './data/template/7_tsound_wenda_header.tpl.php', './source/plugin/tsound_wenda/template', 'header')
;?>
...
<link href="./source/plugin/tsound_wenda/template/images/style.css" rel="stylesheet" type="text/css">
<link href="./source/plugin/tsound_wenda/template/images/wenda.css" rel="stylesheet" type="text/css">

<script src="./source/plugin/tsound_wenda/template/jquery15.min.js" type="text/javascript" ></script>
<!---->
<script type="text/javascript">
var jqwenda = jQuery.noConflict(true);
jqwenda(function(){
if(jqwenda(".wp").width()>960){
  jqwenda("#bdarticle").css("width",jqwenda(".wp").width()-410);
  jqwenda(".extra").css("width", 200);
  jqwenda("#qaside").css("width", 200);
  jqwenda("#caside").css("width", 200);
}else{
  jqwenda("#bdarticle").css("width",jqwenda(".wp").width()-440);
  jqwenda(".extra").css("width", 220);
  jqwenda("#qaside").css("width", 220);
  jqwenda("#caside").css("width", 220);

}
  jqwenda("#qarticle").css("width",jqwenda(".wp").width()-220);

  jqwenda("#carticle").css("width",jqwenda(".wp").width()-220);
})
function resizeWe(){
if(jqwenda(".wp").width()>960){
  jqwenda("#bdarticle").css("width",jqwenda(".wp").width()-410);
