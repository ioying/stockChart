...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1403249108, '5', './data/template/7_5_member_login.tpl.php', './template/links', 'member/login')
