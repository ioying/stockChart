...
0
|| checktplrefresh('./source/plugin/tsound_wenda/template/footer.htm', './template/links/common/footer.htm', 1403249087, 'tsound_wenda', './data/template/7_tsound_wenda_footer.tpl.php', './source/plugin/tsound_wenda/template', 'footer')
;?>
</div>	</div>
