...
0
|| checktplrefresh('./template/links/forum/viewthread_preview.htm', './template/links/forum/viewthread_preview_node.htm', 1411356121, 'diy', './data/template/7_diy_forum_viewthread_preview.tpl.php', './template/links', 'forum/viewthread_preview')
|| checktplrefresh('./template/links/forum/viewthread_preview.htm', './template/links/forum/viewthread_node_body.htm', 1411356121, 'diy', './data/template/7_diy_forum_viewthread_preview.tpl.php', './template/links', 'forum/viewthread_preview')
;?>
...
<h2><?php echo $post['subject'];?> 111111111111 </h2>
<?php } ?>
...
<!--<?php echo $_GET['from'];?> != 'preview' &&  预览模式显示-->
...
<div class="psta vm">
<a href="home.php?mod=space&amp;uid=<?php echo $comment['authorid'];?>" c="1"><?php echo $comment['avatar'];?>222222222</a>
...
<td>
<a href="home.php?mod=space&amp;uid=<?php echo $uid;?>" target="_blank"><?php echo avatar($uid, 'small');; ?></a> <a href="home.php?mod=space&amp;uid=<?php echo $uid;?>" target="_blank"><?php echo $ratelog['username'];?>3333333</a>
...
<?php } } ?>" class="mtn mbn"><a href="home.php?mod=space&amp;uid=<?php echo $uid;?>" target="_blank" class="avt"><?php echo avatar($uid, 'small');; ?>44444444</a></p>
...
<!-------------------------------------------------------------------------------------------------------->						
<!--xx{xx subtemplate forum/viewthread_node_body xx}xx-->
<!-------------点评 收藏 等功能------------------------------------------------------->
<!--xxx{xxx subtemplate forum/viewthread_node_preview xxx}xxx-->
 
<div id="comment_<?php echo $post['pid'];?>" class="cm">
<!-- 预览下可用 <?php echo $_GET['from'];?> != 'preview' && -->
<?php if($_G['setting']['commentnumber'] && !empty($comments[$post['pid']])) { ?>
<h3 class="psth xs1"><span class="icon_ring vm"></span>点评</h3>
<?php if($totalcomment[$post['pid']]) { ?><div class="pstl"><?php echo $totalcomment[$post['pid']];?></div><?php } if(is_array($comments[$post['pid']])) foreach($comments[$post['pid']] as $comment) { ?><div class="pstl xs1 cl">
<div class="psta vm" style = "float: left;">   <!--   暂停头像  echo avatar(<?php echo $uid;?>, 'small'); <?php echo $comment['avatar'];?> -->

<!--	<a href="home.php?mod=space&amp;uid=<?php echo $comment['authorid'];?>" c="1" style=" padding-left: 46px"><img src="http://localhost/bbs/uc_server/avatar.php?uid=<?php echo $comment['authorid'];?>&amp;size=small" height="24" width="24"/></a> -->
<a href="home.php?mod=space&amp;uid=<?php echo $comment['authorid'];?>" c="1" style=" padding-left: 46px"><?php echo $comment['avatar'];?></a>
<?php if($comment['authorid']) { ?> 
<a href="home.php?mod=space&amp;uid=<?php echo $comment['authorid'];?>" class="xi2 xw1"><?php echo $comment['author'];?><?php echo $post['pid'];?></a>
<?php } else { ?>
游客
<?php } ?>
</div>
...
<?php echo $comment['comment'];?>&nbsp;
<?php if($comment['rpid']) { ?>
<a href="forum.php?mod=redirect&amp;goto=findpost&amp;pid=<?php echo $comment['rpid'];?>&amp;ptid=<?php echo $_G['tid'];?>" class="xi2">deta详情</a>
<a href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;repquote=<?php echo $comment['rpid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?><?php if($_GET['from']) { ?>&amp;from=<?php echo $_GET['from'];?><?php } ?>" class="xi2" onclick="showWindow('reply', this.href)">re回复</a>
<?php } ?>
<span class="xg1">
po发表于 <?php echo dgmdate($comment[dateline], 'u');?><?php if($comment['useip'] && $_G['group']['allowviewip']) { ?>&nbsp;IP:<?php echo $comment['useip'];?><?php if($comment['port']) { ?>:<?php echo $comment['port'];?><?php } } if($_G['forum']['ismoderator'] && $_G['group']['allowdelpost']) { ?>&nbsp;<a href="javascript:;" onclick="modaction('delcomment', <?php echo $comment['id'];?>)">删除</a><?php } ?>
</span>
</div>
</div>
<?php } if($commentcount[$post['pid']] > $_G['setting']['commentnumber']) { ?><div class="pgs mbm mtn cl"><div class="pg"><a href="javascript:;" class="nxt" onclick="ajaxget('forum.php?mod=misc&action=commentmore&tid=<?php echo $post['tid'];?>&pid=<?php echo $post['pid'];?>&page=2', 'comment_<?php echo $post['pid'];?>')"><?php echo $post['pid'];?>下一页</a></div></div><?php } } ?>
</div>	
...
<div class="pob cl">
<em>
<?php if($post['invisible'] == 0) { if($allowpostreply && $post['allowcomment'] && (!$thread['closed'] || $_G['forum']['ismoderator'])) { ?>
<!--  原css 弃用 重写
<a class="cmmnt" href="forum.php?mod=misc&amp;action=comment&amp;tid=<?php echo $post['tid'];?>&amp;pid=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?><?php if($_G['forum_thread']['special'] == 127) { ?>&amp;special=<?php echo $specialextra;?><?php } ?>" onclick="showWindow('comment', this.href, 'get', 0)">点评</a> 
-->
<a href="forum.php?mod=misc&amp;action=comment&amp;tid=<?php echo $post['tid'];?>&amp;pid=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?><?php if($_G['forum_thread']['special'] == 127) { ?>&amp;special=<?php echo $specialextra;?><?php } ?>" onclick="showWindow('comment', this.href, 'get', 0)"><img class="vm" src="<?php echo $_G['style']['styleimgdir'];?>cmmnt.gif" alt="" />点评</a>

<?php } if((!$_G['uid'] || $allowpostreply) && !$needhiddenreply) { if($post['first']) { ?>
