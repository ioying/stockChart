...
0
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seditor.htm', 1411356118, '5', './data/template/7_5_forum_forumdisplay_fastpost.tpl.php', './template/links', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/forum/seccheck_post.htm', 1411356118, '5', './data/template/7_5_forum_forumdisplay_fastpost.tpl.php', './template/links', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/upload.htm', 1411356118, '5', './data/template/7_5_forum_forumdisplay_fastpost.tpl.php', './template/links', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seccheck.htm', 1411356118, '5', './data/template/7_5_forum_forumdisplay_fastpost.tpl.php', './template/links', 'forum/forumdisplay_fastpost')
;?>
