...
0
|| checktplrefresh('./template/links/common/header.htm', './template/default/common/header_common.htm', 1405157665, '5', './data/template/7_5_common_header_portal_list.tpl.php', './template/links', 'common/header_portal_list')
;?>
