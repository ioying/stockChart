...
0
|| checktplrefresh('./template/links/common/header.htm', './template/default/common/header_common.htm', 1411356118, '5', './data/template/7_5_common_header_forum_forumdisplay.tpl.php', './template/links', 'common/header_forum_forumdisplay')
;?>
